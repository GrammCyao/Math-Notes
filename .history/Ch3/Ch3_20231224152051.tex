...
\begin{remark}
    The map $\psi\circ F \circ \varphi^{-1}$ is usually called the \emph{coordinate representation of $F$} with respect to the given charts. It maps the set $\varphi(U \cap F^{-1}(V))$
\end{remark}
