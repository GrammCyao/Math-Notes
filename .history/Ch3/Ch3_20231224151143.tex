...
We can observe that smoothness automatically implies continuity. Following corollary shows that is that the smoothness of maps is independent of the choice of charts.
