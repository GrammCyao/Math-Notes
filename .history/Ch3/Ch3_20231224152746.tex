...
\begin{proof}
    ...
    (iii) Let $p\in U$ be arbitrary. and let (V,φ) be a chart in U containing p. Then (V,φ) is also a chart in M containing i(p) = p. Then, φ ◦ i ◦ φ−1 : φ(U) → φ(U) is the identity map, which is smooth. Hence i : U ,→ M is smooth.
