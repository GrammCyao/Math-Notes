...
From Proposition \ref{lem:characterisation of smooth maps}, we see that smoothness automatically implies continuity. Following corollary shows that the smoothness of maps is independent of the choice of charts.
