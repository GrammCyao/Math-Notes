...
\begin{axiom}[Axiom of union]
    Let $A$ be a set, all of whose elements are sets. Then there exists a set $\bigcup A$ whose elements are precisely those objects which are elements of the elements of $A$. Such a set can be represented with the form 
\end{axiom}
