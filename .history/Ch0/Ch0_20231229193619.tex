...
\begin{proof}
    Suppose for sake of contradiction that $\emptyset_1 \neq \emptyset_2$. Then we either have there is an element $x$ such that $x \in \emptyset_1$ but $x \notin \emptyset_2$ or $x \in \emptyset_2$ but $x \notin \emptyset_1$. But both cases are impossible by the definition, a co
\end{proof}
