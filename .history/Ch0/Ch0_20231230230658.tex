...
\begin{remark}
    The axioms of set theory that we have introduced (Axioms \ref{axim:extension} - \ref{axiom:regularity}) are known as the \emph{Zermelo-Fraenkel axioms} (ZF axioms) of set theory, after Ernest Zermelo (1871 - 1953) and Abraham Fraenkel (1891 - 1965). There is 
\end{remark}
