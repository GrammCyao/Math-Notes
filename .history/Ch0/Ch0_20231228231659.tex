...
otherwise we write
    \begin{align*}
        x \notin A.
    \end{align*}
We call a set $A$ \emph{collection} if its elements are sets.
...
\begin{axiom}[Axiom of union]
    Let $A$ be a collection. Then there exists a set $\bigcup A$ whose elements are precisely those objects which are elements of the elements of $A$. In other words, for any object $x$,
        \begin{align*}
            x \in \bigcup A
            \Longleftrightarrow
