...
Now we can define some further operations on sets, namely unions, intersections and difference sets. The \emph{unions} $S_1 \cup S_2$ of two sets is defined to be
    \begin{align*}
