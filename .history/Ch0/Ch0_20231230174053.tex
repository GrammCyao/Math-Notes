...
The axiom of infinity introduces the most basic example of an infinite set, namelyWe will return to this axiom when we set about constructing the natural numbers.
