...
If a set is not equal to the empty set, we call it \emph{non-empty}. The last Lemma asserts that given any non- empty set A, we are allowed to “choose” an element x of A which
