...
The axiom of extension including two fundamental concepts that of set and of element, the element $x$ of set $A$ is written as $x \in A$. The axiom of extension assumes that every mathematical object is a set, it is meaningful to ask whether a set is an element of another set.

assumes that equality is a primitive symbol in predicate logic. Some treatments of axiomatic set theory prefer to do without this, and instead treat the above statement not as an axiom but as a definition of equality.
