...
\begin{definition}[Unions]
    The \emph{unions} $S_1 \cup S_2$ of two sets is defined to be the set
    \begin{align*}
        S_1 \cup S_2 := \bigcup\{S_1, S_2\}.
    \end{align*}
\end{definition}
...
\begin{proof}
    \begin{enumerate}
        \item Suppose that $x \in A \cup \emptyset$. Then we either have $x \in A$ or $x \in \emptyset$. Since $x \notin \emptyset$, we only have $x \in A$. Thus $A \cup \emptyset \subset A$. Conversely, suppose $x \in A$. Then $x \n$
    \end{enumerate}
\end{proof}

From the axiom scheme of specification, we define the intersection $S_1 \cap S_2$ of two sets to be
    \begin{align*}
...
The \emph{difference sets} $A \setminus B$ (or $A - B$) to be the set$A$ with any elements of $B$ removed:
    \begin{align*}
