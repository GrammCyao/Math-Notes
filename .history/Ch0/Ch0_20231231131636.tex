...
\begin{definition}{Relations}
    A \emph{relation} $R$ is a subset of a Cartesian product $X \times Y$. We usually write $x R y$ instead of $(x, y) \in R$. If $R \subset X \times X$, we say that $R$ is a relation over $X$. 
\end{definition}
