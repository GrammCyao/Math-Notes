...
The axiom of extension including two fundamental concepts that of set and of element. The axiom of extension assumes that every mathematical object is a set, it is meaningful to ask whether a set is an element of a set.
...
Also notice that the axiom of extension assumes that equality is a primitive symbol in \emph{predicate logic}, thus the axiom can be rewritten as
    \begin{align*}
