...
\begin{proof}
    Suppose that $A \in A$, then we only have $A \cap A = A = \emptyset$. Since empty set contains no elements, a contradiction. For the second assertion, suppose that $A \in B$ and $B \in A$, 
\end{proof}
