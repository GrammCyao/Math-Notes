...
The axiom of extension including two fundamental concepts that of set and of element, the element $x$ of set $A$ is written as $x \in A$. The axiom assumes that 
