...
\begin{proposition}
    ...
    \begin{enumerate}
        ...
        \item f $A \subset X$ and $B \subset Y$, then $A \times B \subset X \times Y$.
        \item $A \times B \subset X \times Y$, then $A \subset X$ and $B \subset Y$.
        \item Let $A, B$ be non-empty, i
    \end{enumerate}
\end{proposition}
...
\begin{proof}
    ...
    (vi) Suppose that $(x, y) \in A \times B$. Suppose for sake of contradiction that there exists $a \in A$ but $a \notin X$. Then $(a, y) \in A \times B$ and $(a, y) \notin X \times Y$, but it is impossible for that $A \times B \subset X \times Y$. Thus $A \subset X$. A same proof shows that $B \subset Y$.

    (vii) This is directly from the definition. Note that we requires that $A$ and $B$ are non-empty, or equivalently that $A \times B \neq \emptyset$. If $A = \emptyset$, there is no elements such that $x \in A$ so that $x \in A \times B$. Then we can show that for $(x, y) \notin X \times Y$ and $(x, y) \in A \times B$.
\end{proof}
