...
We can see that Definition \ref{def:ordered pair} and Lemma \ref{lem:ordered pair} are equivalent, thus in some textbooks Lemma \ref{lem:ordered pair} is used to be 
