...
If $A, B$ are sets and if every element of $A$ is an element of $B$, we say that $A$ is a \emph{subset} of $B$, denoted A ⊆ B, iff every element of A is also an element of B, i.e.
