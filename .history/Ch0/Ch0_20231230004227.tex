...
\begin{lemma}
    If $(a, b)$ and $(x, y)$ are ordered pairs, then if $(a, b) = (x, y)$, then $a = x$ and $b = y$.
\end{lemma}
...
\begin{proof}
    ...
    If $a \neq b$, then $(a, b)$ and $(x, y)$ contain exactly one singleton, i.e., $\{a\}$ and $\{x\}$. Thus $a = x$. Furthermore, $(a, b)$ and $(x, y)$ contain exactly one pair, i.e., $\{a, b\}$ and $\{x, y\}$, and thus $\{a, b\} = \{x, y\}$. Since $a = x$ and $b \in \{x, y\}$, we only have $b = y$. This complete the proof.
\end{proof}
