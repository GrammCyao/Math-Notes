...
The axiom of infinity introduces the most basic example of an infinite set, namely the set of natural numbersWe will return to this axiom when we set about constructing the natural numbers.
