...
\begin{proof}
    We prove by contradiction. Suppose there does not exist any object $x$ such that x ∈ A. Then for all objects x, x ̸∈ A. Also,byAxiom3.2wehavex̸∈∅. Thusx∈A ⇐⇒ x∈∅ (both statements are equally false), and so A = ∅ by
\end{proof}
